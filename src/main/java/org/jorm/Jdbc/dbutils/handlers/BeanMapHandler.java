 ...
 */
package org.jorm.Jdbc.dbutils.handlers;

import java.sql.ResultSet;
import java.sql.SQLException;

import com.macnss.Libs.dbutils.ResultSetHandler;
import com.macnss.Libs.dbutils.RowProcessor;
...
public class BeanMapHandler<K, V> extends AbstractKeyedHandler<K, V> {
    ...
    public BeanMapHandler(final Class<V> type) {
        this(type, com.macnss.Libs.dbutils.handlers.ArrayHandler.ROW_PROCESSOR, 1, null);
    }
    ...
    public BeanMapHandler(final Class<V> type, final int columnIndex) {
        this(type, com.macnss.Libs.dbutils.handlers.ArrayHandler.ROW_PROCESSOR, columnIndex, null);
    }
